...
import com.foundation.app.basedialog.BaseDialogConfig
import com.foundation.app.basedialog.QuickDialogBuilder
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.tv_show).setOnClickListener {
            ...
            QuickDialogBuilder(
                DialogChangeFloorBinding::class.java,
                object :
                    QuickDialogBuilder.ConvertViewImp<DialogChangeFloorBinding> {
